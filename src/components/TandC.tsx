  ...
  return (
    <ScrollView>
      ...
      <Text style={{...styles.text, fontSize: 18}}>
        ...
        envío según su peso y volumen, dichos artículos no pueden exceder los
        200 puntos en valor de Aduanas de Cuba.
      </Text>
      <Text style={{...styles.text, fontSize: 18}}>
        • Para consultar los valores de Aduanas de Cuba recomendamos descargar
        la aplicación móvil NAC (Normas Aduaneras de Cuba).
      </Text>
      <Text style={{...styles.text, fontSize: 18}}>
        • Ofrecemos artículos para comercio y para consumo personal, el precio
        varía en dependencia de la cantidad de artículos seleccionados.
      </Text>
      <Text style={{...styles.text, fontSize: 18}}>
      ...
      <Text style={{...styles.text, fontSize: 18}}>
        ...
        puede variar el color y la marca, nunca le variará la talla, número o
      ...
      <Text style={{...styles.text, fontSize: 18}}>
        ...
        (CUP Cuba) y algunos electrodomésticos además pagan aranceles, por lo
        que sugerimos consultar la ley de aduana antes de comprar, baría NO se
        hace responsable de estos pagos.
      </Text>
      <Text style={{...styles.text, fontSize: 18}}>
        • Al recibir el paquete o bulto debe estar debidamente sellado, debe
        pedir al agente de Correos de Cuba comprobación de peso si tiene alguna
        duda.
      </Text>
      <Text style={{...styles.text, fontSize: 18}}>
        • En caso de estar su paquete abierto, precintado, o con algún daño no
        debe recibir el paquete; en este caso comunicarse con nosotros.
      </Text>
      <Text style={{...styles.text, fontSize: 18}}>
        • Informamos que existen atrasos con los servicios de entrega de
        paquetería, debido a las complicaciones de la pandemia del covid-19, por
        lo que no podemos indicarle una fecha exacta en la entrega de sus
        paquetes.
      </Text>
      <Text style={{...styles.text, fontSize: 18}}>
