...
import { FlatList, View,Text, TouchableOpacity, ToastAndroid } from 'react-native';
  ...
  const [body, setBody] = useState('');
    ...
    return (
      ...
      <Fab  iconName={'add-outline'}
        ...
        />
        <ModalAddCode title={title} body={body} setBody={setBody} openModal={openModal} isLoading={isLoading} setOpenModal={setOpenModal} onConfirmModal={confirmModal}/>
...
const codeFile = (item: any, navigation: any, deleteCodeFun: any) =>{
  ...
  return(
    <View style={{flexDirection: 'row', flex:1, alignContent: 'space-around', width: '100%', justifyContent: 'space-between'}}>
    
  
<TouchableOpacity activeOpacity={ 0.8 } onPress={() =>navigation.navigate('SingleTrackScreen',{code: item})} style={{paddingHorizontal: 20,marginVertical: 5, backgroundColor:'#fafafa'}}>
