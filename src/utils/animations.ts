...
// Photo album effect
function scrollInterpolator1(index: number, carouselProps: CarouselProps<any>) {
...
// Perspective effect
function scrollInterpolator2(index: number, carouselProps: CarouselProps<any>) {
  const range = [2, 1, 0, -1];
  const inputRange = getInputRangeFromIndexes(range, index, carouselProps);
  const outputRange = range;
...
function scrollInterpolator3(index: number, carouselProps: CarouselProps<any>) {
  const range = [2, 1, 0, -1];
  const inputRange = getInputRangeFromIndexes(range, index, carouselProps);
  const outputRange = range;
